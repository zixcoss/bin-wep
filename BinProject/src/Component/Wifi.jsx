        ...
        <div className="bg-emerald-400 p-8 rounded-lg shadow-md max-w-md w-full text-center">
          ...
          <form className="space-y-4">
            <div>
              ...
              <input type="text" id="wifiName" className="form-input mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-emerald-900" placeholder="Wi-Fi Name" />
            </div>
            <div>
              <label className="block text-left text-sm font-medium text-gray-700 mb-2">Wi-Fi Password</label>
              <input type="password" id="wifiPassword" className="form-input mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-emerald-900" placeholder="Wi-Fi Password" />
            </div>
